...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    NSInteger currentPageIndex = (NSInteger)((scrollView.contentOffset.x + 0.5*self.bounds.size.width) / self.bounds.size.width) % self.imageUrls.count;
    
    if (self.compeletionHandler) {
        self.compeletionHandler(currentPageIndex);
    }
}
